...
export class StudentService {
   ...
   */
  static async createStudent(data: CreateStudentInput, userId: string) {
   ...
   */
  static async deleteStudent(studentId: string, userId: string) {
   ...
   */
  static async enrollInCourse(studentId: string, courseId: string, batchId: string, userId: string) {
   ...
   */
  static async getStudentAttendance(studentId: string, courseId?: string) {
    const whereClause: any = { studentId, deletedAt: null };
   ...
   */
  static async updateStudentProfile(studentId: string, firstName: string, lastName: string, phone?: string) {
    const student = await prisma.student.findUnique({
      where: { id: studentId },
      select: { userId: true },
    });
   ...
   */
  static async generateAndAssignUniqueId(studentId: string, userId: string) {
    const student = await prisma.student.findUnique({ where: { id: studentId } });
   ...
   */
  static async getStudentIdCard(studentId: string) {
    const student = await prisma.student.findUnique({
      where: { id: studentId },
      include: {
        user: {
   ...
   */
  static async enrollByUniqueId(teacherId: string, uniqueId: string, courseId: string, batchId: string, userId: string) {
   ...
   */
  static async withdrawFromCourse(enrollmentId: string, studentId: string, userId: string) {

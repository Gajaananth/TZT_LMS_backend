...
async function getOrCreateSupabaseUser(email, password, firstName, lastName) {
...
async function main() {
    ...
    for (const userData of sampleUsers) {
        ...
        const supabaseUserId = await getOrCreateSupabaseUser(userData.email, userData.password, userData.firstName, userData.lastName);

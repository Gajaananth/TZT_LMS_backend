...
exports.PRE_ENROLLMENT_TEMPLATES = exports.ABUSIVE_WORDS = exports.BLOCKED_EMOJIS = void 0;
exports.normalizeText = normalizeText;
exports.filterContent = filterContent;
exports.isPreEnrollmentTopicAllowed = isPreEnrollmentTopicAllowed;
// Disallowed Emojis: kisses, hugs, hearts, romantic expressions
exports.BLOCKED_EMOJIS = [
    '🤗', '🤭', '😘', '😍', '❤️', '💓', '💕', '💖', '💗', '💘',
    '💙', '💚', '💛', '💜', '🖤', '🤍', '🤎', '💔', '❣️', '💞',
    '💟', '🥰', '😻', '😽', '💋', '💌', '💏', '💑', '👩‍❤️‍👨', '👨‍❤️‍👨',
    '👩‍❤️‍👩', '👩‍❤️‍💋‍👨', '👨‍❤️‍💋‍👨', '👩‍❤️‍💋‍👩', '🫂', '🫦', '🏩', '🌹'
...
const BLOCKED_EMOJI_REGEX = new RegExp(exports.BLOCKED_EMOJIS.map(e => e.replace(/[-/\\^$*+?.()|[\]{}]/g, '\\$&')).join('|'), 'gu');
// Comprehensive list of abusive/vulgar words
// English, Tamil (Tanglish & Tamil script), Sinhala
exports.ABUSIVE_WORDS = [
...
function filterContent(text) {
    const blockedEmojisFound = [];
    const abusiveWordsFound = [];
    ...
    for (const badWord of exports.ABUSIVE_WORDS) {
 ...
 */
function isPreEnrollmentTopicAllowed(text) {
 ...
 */
exports.PRE_ENROLLMENT_TEMPLATES = [
